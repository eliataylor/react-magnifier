...
var Magnifier = (function (_super) {
    ...
    Magnifier.prototype.componentDidMount = function () {
        if (!this.props.trigger) {
            ...
            if (this.props.debug > 0)
                console.log('magnifier: Using default event trigger (img)');
        }
        else {
    ...
    Magnifier.prototype.onMouseEnter = function (e) {
        if (this.props.debug > 0)
            console.log('magnifier: onMouseEnter');
        this.calcImgBounds();
        this.imgHitTest(e);
    };
    Magnifier.prototype.onTouchStart = function (e) {
        e.preventDefault();
        if (this.props.debug > 0)
            console.log('magnifier: onTouchStart');
        this.calcImgBounds();
    };
    Magnifier.prototype.onMouseOut = function (e) {
        this.imgHitTest(e);
        if (this.props.debug > 0)
            console.log('magnifier: onMouseOut');
    };
    Magnifier.prototype.onTouchEnd = function (e) {
        if (this.props.debug > 0)
            console.log('magnifier: onTouchEnd');
        this.imgHitTest(e);
    };
